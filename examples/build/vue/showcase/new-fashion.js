...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  module.exports = {
	    components: {
	      headlines: __webpack_require__(381),
	      category: __webpack_require__(385),
	      coupon: __webpack_require__(386),
	      goods: __webpack_require__(387),
	      resource: __webpack_require__(388),
	      scene: __webpack_require__(389),
	      match: __webpack_require__(390),
	      brand: __webpack_require__(391)
	    },
	    data: {
	      navBarHeight: 88,
	      cnt: 0,
	...
	module.exports.render = function() {with(this){return _h('scroller',{staticClass:["content"]},[_h('refresh',{staticClass:["refresh"],staticStyle:{flexDirection:"row"},attrs:{"display":displayRefresh},on:{"refresh":handleRefresh}},[_h('loading-indicator'),_m(0)]),(show0)?_h('headlines',{attrs:{"ds":showData.header}}):_e(),(show0)?_h('category',{attrs:{"ds":showData.category}}):_e(),(show1)?_h('coupon',{attrs:{"ds":showData.coupon}}):_e(),(show1)?_h('goods',{attrs:{"ds":showData.goods}}):_e(),(show1)?_h('resource',{attrs:{"ds":showData.resource}}):_e(),(show1)?_h('scene',{attrs:{"ds":showData.scene}}):_e(),(show2)?_h('match',{attrs:{"ds":showData.match}}):_e(),(show2)?_h('brand',{attrs:{"ds":showData.brand}}):_e(),_h('loading',{staticClass:["loading"],attrs:{"display":displayLoading},on:{"loading":handleLoading}},[_m(1)])])}}
	module.exports.staticRenderFns = [function(){with(this){return _h('text',{staticStyle:{marginLeft:"36px",color:"#eee"}},["下拉刷新..."])}},
	function() {with(this){return _h('text',{staticStyle:{color:"#eee"}},["加载更多..."])}}]
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  module.exports = {
	    components: {
	      link: __webpack_require__(382),
	      banners: __webpack_require__(383)
	    },
	    props: {
	      ds: {
	        default: function () {
	...
	module.exports.render = function() {with(this){return _h('div',{staticClass:["container"]},[_h('image',{staticClass:["banner"],attrs:{"src":ds.topBanner}}),_h('div',{staticClass:["rule-container"]},[_h('link',{staticStyle:{fontSize:"22px",color:"#ffffff",textAlign:"center"},attrs:{"text":"帮助","href":ds.ruleLink}})]),_h('div',{staticClass:["announce"]},[_h('image',{staticClass:["announce-hd"],attrs:{"src":ds.announceHdBanner}}),_h('banners',{staticStyle:{marginLeft:"6",marginRight:"6"},attrs:{"ds":ds.bannerItems,"direction":"row","width":NUMBER_233,"height":NUMBER_172,"space":NUMBER_3}})])])}}
...
/***/ function(module, exports) {
	...
	module.exports.render = function() {with(this){return _h('text',{on:{"click":clickHandler}},[_s(text)])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  module.exports = {
	    components: {
	      banner: __webpack_require__(384)
	    },
	    props: ['ds', 'width', 'height', 'space', 'direction']
	  };

	module.exports.render = function() {with(this){return _h('div',[(direction==='row')?_h('div',{staticStyle:{flexDirection:"row"}},[_l((ds),function(i,item){return _h('div',{style:{ width: width, height: height, marginLeft: (i % ds.length ? space : 0) }},[_h('banner',{attrs:{"width":width,"height":height,"src":item.img,"href":item.url}})])})]):_e(),(direction==='column')?_h('div',[_l((ds),function(i,item){return _h('div',{style:{ width: width, height: height, marginTop: (i % ds.length ? space : 0) }},[_h('banner',{attrs:{"width":width,"height":height,"src":item.img,"href":item.url}})])})]):_e()])}}
	delete module.exports.el
...
/***/ function(module, exports) {
	...
	module.exports.render = function() {with(this){return _h('image',{style:{ width: width, height: height },attrs:{"src":src,"image-quality":quality},on:{"click":clickHandler}})}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h('div',[(ds.floorTitle)?_h('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}}):_e(),_h('div',{staticClass:["item-container"]},[_l((items),function(i,item){return _h('div',{style:{ width: 750, paddingBottom: 14, backgroundColor: item.colour }},[_h('div',[_h('banner',{attrs:{"width":NUMBER_750,"height":NUMBER_237,"src":i % 2 === 0 ? item.leftBannerImg : item.rightBannerImg,"href":item.bannerUrl}})]),_h('div',{staticClass:["shop-list"]},[_l((item.shopList),function(shop){return _h('div',{staticClass:["shop-img-container"]},[_h('banner',{attrs:{"width":NUMBER_186,"height":NUMBER_208,"src":shop.picUrl,"href":shop.shopUrl}})])})])])})]),_h('div',{staticClass:["sub-item-container"],style:{ height: Math.round(subItems.length / 3) * (241 + 3) }},[_l((subItems),function(i,item){return _h('div',{staticClass:["sub-item"],style:{top: getSubItemTop(i), left: getSubItemLeft(i) }},[_h('image',{staticClass:["sub-item-bg"],attrs:{"src":subItemBg}}),_h('div',{staticClass:["sub-item-img"]},[_h('banner',{attrs:{"width":NUMBER_248,"height":NUMBER_155,"src":item.industryImg,"href":item.industryUrl}})]),_h('div',{staticClass:["sub-item-title"]},[_h('text',{staticClass:["industry-title"],attrs:{"href":item.industryUrl}},[_s(item.industryTitle)]),_h('text',{staticClass:["industry-benefit"],attrs:{"href":item.industryUrl}},[_s(item.industryBenefit)])])])})])])}}
	delete module.exports.el
...
/***/ function(module, exports) {
	...
	module.exports.render = function() {with(this){return _h('div',[(ds.floorTitle)?_h('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}}):_e(),_h('div',{staticClass:["wrapper"]},[_h('image',{staticClass:["img"],attrs:{"src":currentStatus}}),_h('div',{staticClass:["my-coupon"],on:{"click":handleClick}}),_h('div',{staticClass:["guides"],on:{"click":handleClick}}),_h('div',{staticClass:["lottery"],on:{"click":handleClick}})])])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return (!ds.isHide)?_h('div',[(ds.floorTitle)?_h('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}}):_e(),_h('slider',{staticClass:["slider"],attrs:{"show-indicators":"true","auto-play":"true","interval":"3000"}},[_l((ds.bannerItems),function(item){return _h('div',{staticClass:["pannel"]},[_h('div',[_h('banner',{staticStyle:{marginBottom:"4"},attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img1,"href":item.url1}}),_h('banner',{attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img2,"href":item.url2}})]),_h('div',{staticClass:["middle-col"]},[_h('banner',{attrs:{"width":NUMBER_240,"height":NUMBER_588,"src":item.img3,"href":item.url3}})]),_h('div',[_h('banner',{staticStyle:{marginBottom:"4"},attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img4,"href":item.url4}}),_h('banner',{attrs:{"width":NUMBER_251,"height":NUMBER_292,"src":item.img5,"href":item.url5}})])])}),_m(0)])]):_e()}}
	module.exports.staticRenderFns = [function(){with(this){return _h('indicator',{staticStyle:{position:"absolute",width:"714",height:"200",left:"10",bottom:"-80",itemSize:"20",itemColor:"#999999",itemSelectedColor:"#000000"}})}}]
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return (!ds.isHide)?_h('div',[_h('div',{staticClass:["big-banner-container"]},[_h('banner',{attrs:{"width":NUMBER_750,"height":NUMBER_200,"src":ds.bigBannerImg,"href":ds.bigBannerUrl}})]),_h('banners',{attrs:{"direction":"row","ds":ds.smallBannerItems,"width":NUMBER_373,"height":NUMBER_224,"space":NUMBER_4}})]):_e()}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h('div',[(ds.floorTitle)?_h('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}}):_e(),_h('div',{staticClass:["small-item-container"],style:{ height: Math.round(smallItems.length/2)*234 }},[_l((smallItems),function(i,item){return _h('div',{staticClass:["small-item"],style:{ top: getItemTop(i), left: getItemLeft(i) }},[_h('div',[_h('image',{staticClass:["small-item-bg"],attrs:{"src":smallItemBg}})]),_h('div',{staticClass:["small-item-img"]},[_h('banner',{attrs:{"width":NUMBER_186,"height":NUMBER_206,"src":item.itemImg,"href":item.sceneUrl}})]),_h('div',{staticClass:["small-benifit-img"]},[_h('banner',{attrs:{"width":NUMBER_170,"height":NUMBER_100,"src":item.benefitImg,"href":item.sceneUrl}})])])})])])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h('div',[(ds.floorTitle)?_h('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}}):_e(),(ds.isShowTmSpecBanner && ds.tmSpecBanner)?_h('div',{staticClass:["tm-banner"]},[_h('banner',{attrs:{"width":NUMBER_750,"height":NUMBER_200,"src":ds.tmSpecBanner.img,"href":ds.tmSpecBanner.url}})]):_e(),_l((ds.bannerItems),function(item){return _h('div',{style:{ flexDirection: 'row', marginBottom: NUMBER_4 }},[_h('div',{style:{ marginRight: NUMBER_4 }},[_h('banner',{attrs:{"width":NUMBER_373,"height":NUMBER_240,"src":item.leftImg,"href":item.leftUrl}})]),_h('div',[_h('banner',{attrs:{"width":NUMBER_373,"height":NUMBER_240,"src":item.rightImg,"href":item.rightUrl}})])])})])}}
	delete module.exports.el
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports.render = function() {with(this){return _h('div',{staticClass:["container"]},[(ds.floorTitle)?_h('image',{staticClass:["title"],attrs:{"src":ds.floorTitle}}):_e(),_h('div',{staticStyle:{marginLeft:"4",marginRight:"4"}},[_h('banners',{attrs:{"direction":"column","ds":bannerItems,"width":NUMBER_742,"height":NUMBER_230,"space":NUMBER_4}})])])}}
	delete module.exports.el
