...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/slider-neighbor-page', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	module.exports = {
	  ...
	  "children": [
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "value": "1. wxc-panel has a default margin left, conflict with slider-neighbor, so DONOT use slider-neighbor in wxc-panel."
	          }
	        }
	      ]
	    },
	    {
	      ...
	      "attr": {
	        "value": "1. Default Usage. neighbor-space=150; neighbor-alpha=0.6; neighbor-scale=0.8;"
	      }
	    },
	    {
	    ...
	    },
	    {
	      ...
	      "attr": {
	        "value": "2. neighbor-space = 190, this property number works with slider-item width."
	      }
	    },
	    {
	      "type": "slider-neighbor",
	    ...
	    },
	    {
	      ...
	      "attr": {
	        "value": "3. neighbor-scale = 0.7, Also makes neighbor view smaller. too small will not be seen on screen."
	      }
	    },
	    {
	      "type": "slider-neighbor",
